...
export default {
  ...
  //       title: '用户帮助',
  //       children: [{
  //         project: ['申请退款', '查看美团券密码', '常见问题', '用户协议', '隐私政策', '反诈骗公告', '消费者权益保障']
  //       },
  //       {
  //         title: '美团服务',
  //         children: [{
  //           project: ['美团外卖', '美团酒店', '猫眼电影', '美团配送', '美团云', '大众点评', '美团民宿', '无人配送']
  //         }]
  //       },
  //       {
  //         title: '商家合作',
  //         children: [{
  //           project: ['美团餐饮商户中心', '美食商家入驻(非外卖)', '美团外卖开店申请', '美团收银官网', '外卖配送加盟申请', '美团点评餐饮学院', '酒店商家入驻', '境内度假商家入驻', '综合商家入驻', '美团民宿房东商家入驻', '商家开票申请', '美团点评智能收银机', '美团点评餐饮开放平台', '美团点评收单', '免费使用美团排队', '快驴进货商家合作', '美团闪购商家入驻']
  //         }]
  //       },
  //       {
  //         title: '代理商加盟',
  //         children: [{
  //           project: ['美团外卖代理商招募', '到店餐饮代理商招募', '非餐饮代理商招募', '美团联盟', '美团收银招募线上分销商', '美团点评5S服务商招募', '美团收单渠道代理商招募']
  //         }]
  //       },
  //       {
  //         title: '美团规则',
  //         children: [{
  //           project: ['规则中心', '规则目录', '规则评议院']
  //         }]
  //       },
  //       {
  //         title: '关注美团',
  ...
  //         title: '公司信息',
  //         children: [{
  //           project: ['关于我们', '投资者关系', '加入我们', '商户诚信公约及管理办法', '保险经纪资质']
  //         }]
  //       },
  //       {
  //         title: '廉正举报',
...
<style lang="scss">
@import "src/assets/css/public/footer.scss";
</style>
